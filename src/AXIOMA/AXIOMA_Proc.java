...
public class AXIOMA_Proc extends Thread{

    private QueueConnection mqConnection = null;
    private String mqQueueURI = NTCommon.AXIOMA_Write;
    ...
    public AXIOMA_Proc(String replyId, String corId, String messText) {
        replyID = replyId;
        corID = corId;
    ...
    @Override
    public void run() {
        CommomEnv.Delay(CommomEnv.randomTimeout(NTCommon.AXIOMA_dellay, NTCommon.AXIOMA_dellay_dev));
        String DocumentId = StringUtils.substrigBetween(messageText, "DocumentId=\"", "\"");
    ...
    private String ApplicationResponce(String OperationId) {
        ...
        CommomEnv.logMessage("AXIOMAapp_Processing", "Sending ApplicationResponse.");
